...
View release: https://github.com/agyekumboadi/player-performance-ml-pipeline/releases/tag/v1.1-evidence-snapshot
...
The visuals below are a small, curated subset of outputs generated by the pipeline.  
Full folders are linked so assessors can verify additional artefacts quickly.

<details>
<summary><b>Workflow and dataset flow</b></summary>
...
<details>
<summary><b>Selected exploratory analysis visuals</b> (click to expand)</summary>

Full folder: [view all EDA visuals](outputs/eda_visuals)
...
### Goal contribution distribution (goals + assists)
![goal contribution distribution (goals + assists)](outputs/eda_visuals/goal_contribution_distribution.png)

### Minutes played vs goal contribution (bubble)
...
<details>
<summary><b>Evaluation output example</b> (basketball test)</summary>
...
<details>
<summary><b>Explainability outputs (SHAP)</b></summary>

### SHAP summary (cross-sport)
...
<details>
<summary><b>PCA diagnostics</b></summary>
